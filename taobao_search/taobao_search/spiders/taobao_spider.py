...
class TaobaoTrueFinalSpider(scrapy.Spider):
    ...
    # ====================== 你的有效信息 ======================
    token = "834764bcedecac2a519b15c81bee210b"
    YOUR_COOKIE = 't=0d45b2241cc5de5605cdb5b92f7757b8; cna=gdI3In72RVECAXjnZvEDKa6o; thw=cn; _tb_token_=ff859674b9777; cookie2=1a389e716e421cd162891e3780b8e77e; 3PcFlag=1774236268509; wk_cookie2=1c22cab40e53ce1647af94246d36e1cf; wk_unb=UUphy%2FeHvMowD%2Fm8yw%3D%3D; _hvn_lgc_=0; havana_lgc2_0=eyJoaWQiOjIyMDE1MjU2OTM0NTgsInNnIjoiYWUyZDlkNTZmYWIyNzgxYTQ2YWNlYzc1ODA2M2U4ZTIiLCJzaXRlIjowLCJ0b2tlbiI6IjFrV1V4VkFnY0F3UUQyNlZwRzVkamhnIn0; lgc=tb803185300; cancelledSubSites=empty; dnk=tb803185300; tracknick=tb803185300; sn=; unb=2201525693458; uc1=cookie16=WqG3DMC9UpAPBHGz5QBErFxlCA%3D%3D&cookie15=URm48syIIVrSKA%3D%3D&cookie21=UtASsssme%2BBq&existShop=false&pas=0&cookie14=UoYZbjLBjofckQ%3D%3D; uc3=lg2=URm48syIIVrSKA%3D%3D&nk2=F5RNZTlfaucdizs%3D&id2=UUphy%2FeHvMowD%2Fm8yw%3D%3D&vt3=F8dD29QBybqNTq03aew%3D; csg=b4a2d266; cookie17=UUphy%2FeHvMowD%2Fm8yw%3D%3D; skt=16c9dd3ecb781544; existShop=MTc3NDc2NTI3NQ%3D%3D; uc4=nk4=0%40FY4GsvaDMHH78ft2mRQBsdZA7NbHIg%3D%3D&id4=0%40U2grEJAUx4Nh0bJTn%2BQld4btZDz0q80w; _cc_=Vq8l%2BKCLiw%3D%3D; _l_g_=Ug%3D%3D; sg=080; _nk_=tb803185300; cookie1=VWt8kDm9nyptZQml2AC66P6U3Xs%2B5QQKg7HNpNDN1Fg%3D; sgcookie=E1004QFSVZFjFwm0saPCPj%2BOiziIHZRewfXXER01U%2BSH545gMzvLC8XA3w4AviWtKBDf0t750icZq6WqYVIgMWjAo%2Bo5sIYibKrnZsEKUXU3pZM%3D; xlly_s=1; mtop_partitioned_detect=1; _m_h5_tk=834764bcedecac2a519b15c81bee210b_1774852511419; _m_h5_tk_enc=44347f0e3aaffc00eb591ce7d0e8551b; _samesite_flag_=true; havana_lgc_exp=1805946073132; sdkSilent=1774870873132; havana_sdkSilent=1774870873132; tfstk=gu5qX56-bSFVliZh8wAaU5x8DzdvGCrCn1t6SNbMlnxDlGONQMKS1rdbBCSw4GKXhIxj_1-l-Phbk-pMbidDBtt6chRNWMz7AWNCkZd9ZkZQOuxxLCdDoFcDmPAkJFUWovghY8d9skZWSzfyTCIVyHaeIYYk2F8ionjMZ0YeqFDDsGxkEeYImCAGjz-kJFHiidvcr4xJSCxGjn4Pr3LwshjMsz7oCwjGDb-ynr5nPln8Z29vxZxrsXupoKqGlAGZ_8TDnHvkwfYVaEJ2xZfh-W4Mr_1ydLg_2QbdFiYyT7MDtaWGY9jTdYdVStj9UiE-U36lFNxMh2le3OYwKCvrSfbyM3v1iBVn4UBllOfA0VlMks1BQHpzSfp6Z69hKiuTJaADSGpd1khvmNbd99OUNxAhzOjFQgzEXUVgC1BqjAJDyU-Qzzo4htZFuqrUrAH9U8LyAyUKBApDyU-QzzktBL5JzHaLJ;',
    # ========================================================
    ...
    def parse(self, response):
        ...
        try:
            ...
            for item in items:
                ...
                taobao_item['keyword'] = kw
                taobao_item['title'] = result['标题']
                taobao_item['price'] = result['价格']
